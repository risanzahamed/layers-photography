                ...
                <div class="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
                        <div class="flex flex-col justify-between lg:py-5">
                            <h2 class="text-3xl font-bold leading-tight text-white sm:text-4xl lg:leading-tight lg:text-5xl">Capture Memorable Moments: Our Price Table for Photography Services Unveiled!</h2>
                            ...
                            <div class="mt-auto">
                                ...
                                <blockquote class="mt-6">
                                    <p class="text-lg leading-relaxed text-white">Discover our transparent and flexible photography service price table. From weddings to product shoots, we offer exceptional value and customizable packages to suit every budget. Book your moment today!</p>
                                </blockquote>
                                ...
                                <div class="flex items-center mt-8">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-px text-sm text-gray-400">Wedding Client</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="">
                            <div class="overflow-hidden bg-white rounded-md">
                                <div class="p-10">
                                    ...
                                    <p class="mt-4 text-6xl font-bold text-black">$199</p>
                                    ...
                                    <ul class="flex flex-col mt-8 space-y-4">
                                        <li class="inline-flex items-center space-x-2">
                                            ...
                                            <span class="text-base font-medium text-gray-900"> Captivating Moments on a Budget </span>
                                        </li>
                                        ...
                                        <li class="inline-flex items-center space-x-2">
                                            ...
                                            <span class="text-base font-medium text-gray-900"> Unleash Your Inner Model </span>
                                        </li>
                                        ...
                                        <li class="inline-flex items-center space-x-2">
                                            ...
                                            <span class="text-base font-medium text-gray-900"> Picture-Perfect Memories </span>
                                        </li>
                                        ...
                                        <li class="inline-flex items-center space-x-2">
                                            ...
                                            <span class="text-base font-medium text-gray-900"> Capture the Essence of Your Special Day </span>
                                        </li>
                                        ...
                                        <li class="inline-flex items-center space-x-2">
                                            ...
                                            <span class="pb-0.5 text-base font-medium text-gray-900 border-b border-black border-dashed"> From Product to Portrait </span>
                                        </li>
                                    </ul>
